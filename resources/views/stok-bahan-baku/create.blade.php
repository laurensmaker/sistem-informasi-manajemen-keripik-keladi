...
<div class="d-sm-flex justify-content-between align-items-center mb-4">
    <h3 class="fs-18">Tambah Stok Bahan Baku</h3>
...
<div class="card bg-white border-0 rounded-10 mb-4">
    <div class="card-body p-4">
        <form action="{{ route('stok-bahan-baku.store') }}" method="POST">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <input type="datetime-local" 
                           ...
                           value="{{ old('tanggal_update', now()->format('Y-m-d\TH:i')) }}"
                           required>
                ...
                <div class="col-lg-4 mb-3">
                    ...
                    <div class="input-group">
                        <input type="number" 
                               ...
                               step="0.01"
                               required>
                        <span class="input-group-text" id="satuan_stok">-</span>
                    </div>
                    @error('jumlah_stok')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="col-lg-4 mb-3">
                    ...
                    <div class="input-group">
                        <input type="number" 
                               ...
                               value="{{ old('jumlah_masuk', 0) }}"
                               placeholder="0" 
                               min="0"
                               step="0.01"
                               required>
                        <span class="input-group-text" id="satuan_masuk">-</span>
                    </div>
                    @error('jumlah_masuk')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="col-lg-4 mb-3">
                    ...
                    <div class="input-group">
                        <input type="number" 
                               ...
                               value="{{ old('jumlah_keluar', 0) }}"
                               placeholder="0" 
                               min="0"
                               step="0.01"
                               required>
                        <span class="input-group-text" id="satuan_keluar">-</span>
                    </div>
                    @error('jumlah_keluar')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="col-lg-12">
                    <div class="alert alert-success" id="hasilStok">
                        ...
                        <span id="stok_akhir">0</span>
                    </div>
                </div>

                <div class="col-lg-12 mt-3">
                    <button type="submit" class="btn btn-primary">
                        <i data-feather="save"></i> Simpan Stok
                    </button>
...
<script>
    ...
    function hitungStokAkhir() {
        ...
        // Ubah warna jika stok akhir negatif
